...
class UserService:
    ...
    def _setup_cache_managers(self):
        ...
        # 3. Redis存储 + MessagePack序列化 - 适合大数据量
...
class ProductService:
    ...
    @u_l_cache(ttl_seconds=1200, storage_type=StorageType.REDIS)
