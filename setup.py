...
setup(
    ...
    version=get_version(),
    author="WangZhanze",
    author_email="wangzhanze@huoban.ai",
    description="轻量级通用缓存库",
    long_description=read_readme(),
    long_description_content_type="text/markdown",
    url="https://github.com/huoban-ai/l-cache",
    ...
    project_urls={
        "Bug Reports": "https://github.com/huoban-ai/l-cache/issues",
        "Source": "https://github.com/huoban-ai/l-cache",
